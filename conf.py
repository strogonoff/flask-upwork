...
version = __import__('flaskext').get_version()[:2]
# The full version, including alpha/beta/rc tags.
release = __import__('flaskext').get_version()
...
# of the sidebar.
html_logo = '_static/flaskodesk.png'
...
htmlhelp_basename = 'flask-odeskhtml'
...
# [howto/manual]).
latex_documents = [
  ('index', 'flask-odesk.tex', u'Flask-oDesk Documentation',
   u'odesk', 'manual'),
]
